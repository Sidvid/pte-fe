...
function WFDPredictionQuestion() {
    ...
    <div className="flex flex-col gap-6 p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
      ...
      <div className="mt-6">
        ...
        <p className="text-sm text-gray-600 mb-3">
          Enter the text that will be read aloud in the audio. Students will type what they hear.
        </p>
        
        <TextArea
          value={script}
          onChange={(e) => setScript(e.target.value)}
          placeholder="Enter the dictation text that students will hear and need to type..."
          rows={6}
          showCount
          maxLength={1000}
      ...
      <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <p className="text-base font-semibold text-gray-700 mb-2">About WFD Prediction:</p>
        <p className="text-gray-600">
          Students will listen to the audio and write down exactly what they hear. 
          This tests both listening comprehension and spelling abilities.
        </p>
      </div>
    </div>
  );
...
export default WFDPredictionQuestion;